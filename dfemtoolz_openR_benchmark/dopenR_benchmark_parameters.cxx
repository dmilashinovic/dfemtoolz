...
#include "dopenR_benchmark_parameters.h"


openR_benchmark_Parameters::openR_benchmark_Parameters()
{
...
openR_benchmark_Parameters * openR_benchmark_Parameters::m_popenR_benchmark_ParametersSingleton = 0;
openR_benchmark_Parameters * openR_benchmark_Parameters::create_openR_benchmark_Parameters()
{
    if (m_popenR_benchmark_ParametersSingleton == 0)
        m_popenR_benchmark_ParametersSingleton = new openR_benchmark_Parameters();
    return m_popenR_benchmark_ParametersSingleton;
}

openR_benchmark_Parameters::~openR_benchmark_Parameters()
{}

bool openR_benchmark_Parameters::read_file()
{
